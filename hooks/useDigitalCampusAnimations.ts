...
export const useDigitalCampusAnimations = (
  ...
  useEffect(() => {
    ...
    const mobileMockup = document.querySelector('.premium-mobile-mockup');
    ...
    const ctx = gsap.context(() => {
      ...
      if (mobileMockup) {
        gsap.fromTo(mobileMockup,
          { opacity: 0, x: 50, scale: 0.9, force3D: true },
          {
            opacity: 1,
            x: 0,
            scale: 1,
